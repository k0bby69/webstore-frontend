  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        const profileResponse = await fetch(`https://webstore-userservice.onrender.com/profile`, {
          method: 'GET',
          headers: {
        ...
        const wishlistDetails = await Promise.all(
          wishlistIds.map(async (id) => {
            ...
            const itemResponse = await fetch(`https://webstore-userservice.onrender.com/${id}`, {
              method: 'GET',
              headers: {
